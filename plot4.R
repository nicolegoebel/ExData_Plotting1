# plot 4 in R using Electric pwer consumption data
...
#plot 2
plot(dat$DateTime, dat$Voltage, type="n",ylab="Voltage", xlab="datetime")
...
# plot 4
plot(dat$DateTime, dat$Global_reactive_power, type="n",ylab="Global_reactive_power", xlab="datetime")
